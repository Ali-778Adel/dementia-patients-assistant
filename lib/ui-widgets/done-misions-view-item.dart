...
@immutable
class CustomDoneMissionsViewItem  extends StatelessWidget {
  final  RepeatableMissionsTable missionViewModel;
  final Function()onMissionTapped;
  final Function()onLongPress;
  const CustomDoneMissionsViewItem({Key? key,required this.missionViewModel,required this.onMissionTapped,required this.onLongPress}) : super(key: key);
  @override
