...
@immutable
class CustomDailyMissionViewItem extends StatelessWidget {
Color getColorStatus(){
  Color?color;
  switch(missionViewModel.missionRepeat){
    case 'custom':{
...
final Function()onLongPress;
  const CustomDailyMissionViewItem({Key? key,required this.missionViewModel,required this.onMissionTapped,required this.onLongPress}) : super(key: key);
  @override
