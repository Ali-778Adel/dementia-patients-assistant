...
import 'package:untitled/face-detection/utils/coordinates-printer.dart';

class FaceDetectorPrinter extends CustomPainter{
  final List<Face>faces;
  final Size absoluteImageSize;
  final InputImageRotation rotation;
  FaceDetectorPrinter(this.faces,this.absoluteImageSize,this.rotation);
  @override
        ...
        if(faceContour?.points !=null){
          for(final Point point in faceContour!.points){
            canvas.drawCircle(Offset(
                ...
                translateY(point.y.toDouble(), rotation, size, absoluteImageSize)), 1.0, paint);
          }
  ...
  @override
  bool shouldRepaint(final FaceDetectorPrinter oldDelegate) {
